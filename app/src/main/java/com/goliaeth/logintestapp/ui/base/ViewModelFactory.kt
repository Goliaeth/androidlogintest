...
import com.goliaeth.logintestapp.ui.home.HomeVieModel
...
class ViewModelFactory (
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return when {
            ...
            modelClass.isAssignableFrom(HomeVieModel::class.java) -> HomeVieModel(repository as UserRepository) as T
